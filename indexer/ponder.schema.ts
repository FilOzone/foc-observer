...
export const pdpPiecesScheduledForRemoval = tables.pdp_pieces_scheduled_for_removal
...
export const fwssDataSetAuthorizerSet = tables.fwss_data_set_authorizer_set
...
// PoRep Market (fidlabs cold-storage market on shared FilecoinPay), V1 (V2 not indexed)
