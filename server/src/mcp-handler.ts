...
All event tables have: tx_hash, block_number, timestamp. For tx_from, tx_value, gas_used, effective_gas_price: JOIN tx_meta USING (tx_hash). One row per tx in tx_meta.
